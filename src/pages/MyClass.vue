        ...
        <div class="flex justify-between items-center flex-wrap">
          ...
          <div class="content">
            ...
            <section v-if="!isCalender">
              ...
              <startClassModal :showfirstModal="showfirstModal" v-on:closeModal="closeModal" :isDisabled="true" :title="''" v-on:submit="submit" />
              ...
              <CourseModel :showfirstModal="showDetailModal" v-on:closeModal="closeModal" :isDisabled="true" :title="''" v-on:submit="submit" />
              <CourseRecordModal :showfirstModal="showCommentModal" v-on:closeModal="closeModal" :isDisabled="true" :title="''" v-on:submit="submit" />
              <div class="flex items-center justify-center flex-wrap">
                <div class="bg-white px-2 py-2 hover:shadow-lg transition duration-500 w-full flex borderGreen mb-3 border-l-4 borderGreen flex-col md:flex-row"  v-for="n in 5" :key="n">
